...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-8 col-md-8 col-lg-8 mt-md-0">
            <img class="img-fluid" src="{{ '/assets/img/material-eval.gif' | relative_url }}" alt="" />
            <div class="caption">
                Live material measurement. 
            </div>
        </div>
        <div class="col">
        </div>
...
This project is supported by BoR LAMDA Seed Grant. 

Open source code repo: [https://github.com/Nasser-Mohammed/MechE_Nail_Statistics](https://github.com/Nasser-Mohammed/MechE_Nail_Statistics). 
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-md-0">
            <img class="img-fluid" src="{{ '/assets/img/material-team.png' | relative_url }}" alt="" />
        </div>
        <div class="col">
        </div>
    </div>

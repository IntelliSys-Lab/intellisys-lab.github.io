...
:pencil: [arXiv 2511.08905](https://arxiv.org/pdf/2511.08905) 

<div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mx-auto d-block">
        <img class="img-fluid rounded" src="{{ '/assets/img/iseal-workflow.png' | relative_url }}" alt="" />
        <div class="caption">
            Pipeline of iSeal. A secret-keyed encoder maps plaintexts to ciphertexts, and the LLM is trained to reconstruct Reed-Solomon Code (RSC) encoded targets. Ownership is verified by querying the suspect API and matching decoded outputs.
        </div>
    </div>
</div>
<br />
